...
13. [🛡️ Идемпотентность и предотвращение повторной отправки сообщений](#-9-идемпотентность-и-предотвращение-повторной-отправки-сообщений)
14. [🗄️ Outbox на PostgreSQL и управление вычеткой](#-10-outbox-на-postgresql-и-управление-вычеткой)
