...
[📨 Реактивный мессенджер — обзор](#-реактивный-мессенджер)
[🚀 Ключевая идея](#-ключевая-идея)
[🧩 Основные технологии](#-основные-технологии)
[🧭 Идеология проекта](#-идеология-проекта)
[⚙️ Ядро системы — Машина состояний (Pipeline)](#-1-ядро-системы--машина-состояний-pipeline)
[⚡️ Реактивная модель и управление нагрузкой](#-2-реактивная-модель-и-управление-нагрузкой)
[💳 Механизм кредитов пользователей](#-3-механизм-кредитов-пользователей)
[🧱 Архитектурный подход — Hexagonal Architecture](#-4-архитектурный-подход--hexagonal-architecture)
[🧾 Гарантии и цели](#-5-гарантии-и-цели)
[💬 Типы сообщений и их маршруты](#-6-типы-сообщений-и-их-маршруты)
[🧹 Механизм очистки Outbox (Garbage Collector)](#-7-механизм-очистки-outbox-garbage-collector)
[🧭 Горизонтальное масштабирование и шардирование клиентов](#-8-горизонтальное-масштабирование-и-шардирование-клиентов)
[🛡️ Идемпотентность и предотвращение повторной отправки сообщений](#-9-идемпотентность-и-предотвращение-повторной-отправки-сообщений)
[🗄️ Outbox на PostgreSQL и управление вычиткой](#-10-outbox-на-postgresql-и-управление-вычиткой)
[🧩 Структура папок проекта](#-11-структура-папок-проекта)
[🧭 Итоги и дальнейшее развитие](#-итоги-и-дальнейшее-развитие)
[🧩 PS. Продвинутая архитектура масштабируемого acknowledgment и очистки (Tetris Model)](#-ps-продвинутая-архитектура-масштабируемого-acknowledgment-и-очистки-tetris-model)
[📖 PSS. Термины и объяснения](#-pss-термины-и-объяснения)
...
## 🗄️ 10. Outbox на PostgreSQL и управление вычиткой
